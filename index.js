const contentLetterSrart_actived = "Gửi thằng em trùm âm nhạc của anh 😁😁." //Lời mở đầu cho bức thư
const mainContentLetter = "Chúc em a tuổi mới vui vẻ thành công vs mọi quyết định của mình đặc biệt là đam mê của em nhé🥳🥳 ." //Nội dung của bức thư
